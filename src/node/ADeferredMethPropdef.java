...
public final class ADeferredMethPropdef extends PPropdef
{
    private PDoc _doc_;
    ...
    public Object clone()
    {
        return new ADeferredMethPropdef(
    ...
    {
        ((Analysis) sw).caseADeferredMethPropdef(this);
    }
