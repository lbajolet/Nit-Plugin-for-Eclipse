...
public final class AConcreteInitPropdef extends PPropdef
{
    private PDoc _doc_;
    ...
    public Object clone()
    {
        return new AConcreteInitPropdef(
    ...
    {
        ((Analysis) sw).caseAConcreteInitPropdef(this);
    }
