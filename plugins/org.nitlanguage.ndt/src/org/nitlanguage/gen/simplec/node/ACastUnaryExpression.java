...
public final class ACastUnaryExpression extends PUnaryExpression
{
    ...
    public Object clone()
    {
        return new ACastUnaryExpression(
    ...
    {
        ((Analysis) sw).caseACastUnaryExpression(this);
    }
