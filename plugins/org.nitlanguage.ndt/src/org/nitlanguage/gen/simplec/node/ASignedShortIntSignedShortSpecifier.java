...
public final class ASignedShortIntSignedShortSpecifier extends PSignedShortSpecifier
{
    private TSigned _signed_;
    private TShort _short_;
    private TInt _int_;

    public ASignedShortIntSignedShortSpecifier()
    {
    }
    ...
    public Object clone()
    {
        return new ASignedShortIntSignedShortSpecifier(
    ...
    {
        ((Analysis) sw).caseASignedShortIntSignedShortSpecifier(this);
    }
