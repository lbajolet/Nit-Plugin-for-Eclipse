...
public final class AUnionDeclaration extends PUnionDeclaration
{
    ...
    {
        ((Analysis) sw).caseAUnionDeclaration(this);
    }
    ...
    private class MemberDeclaration_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AUnionDeclaration.this))
            {
                node.parent().removeChild(node);
            }
