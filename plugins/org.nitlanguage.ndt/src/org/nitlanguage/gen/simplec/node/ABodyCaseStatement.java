...
public final class ABodyCaseStatement extends PCaseStatement
{
    ...
    {
        ((Analysis) sw).caseABodyCaseStatement(this);
    }
    ...
    private class Statement_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != ABodyCaseStatement.this))
            {
                node.parent().removeChild(node);
            }
