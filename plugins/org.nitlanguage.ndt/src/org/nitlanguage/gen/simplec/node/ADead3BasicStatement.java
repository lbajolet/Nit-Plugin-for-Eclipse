...
public final class ADead3BasicStatement extends PBasicStatement
{
    ...
    public Object clone()
    {
        return new ADead3BasicStatement(
    ...
    {
        ((Analysis) sw).caseADead3BasicStatement(this);
    }
