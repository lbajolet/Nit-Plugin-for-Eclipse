...
public final class AIdentifierVariableDeclaration extends PVariableDeclaration
{
    ...
    public AIdentifierVariableDeclaration()
    {
    }
    ...
    public Object clone()
    {
        return new AIdentifierVariableDeclaration(
    ...
    {
        ((Analysis) sw).caseAIdentifierVariableDeclaration(this);
    }
    ...
    private class AdditionalDeclarator_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AIdentifierVariableDeclaration.this))
            {
                node.parent().removeChild(node);
            }
