...
public final class AUnsignedShortIntUnsignedShortSpecifier extends PUnsignedShortSpecifier
{
    private TUnsigned _unsigned_;
    private TShort _short_;
    private TInt _int_;

    public AUnsignedShortIntUnsignedShortSpecifier()
    {
    }
    ...
    public Object clone()
    {
        return new AUnsignedShortIntUnsignedShortSpecifier(
    ...
    {
        ((Analysis) sw).caseAUnsignedShortIntUnsignedShortSpecifier(this);
    }
